  ...
  showModal("Security",
    ...
    function(password) {
      ...
      try {
        ...
        setTimeout(function() {
          if (e.message == "Cannot read property 'join' of null" || e.message == "Malformed UTF-8 data") {
            showDialogue("Password mismatch", "The password you entered is not <b>correct</b> therefore the transaction has been canceled.");
          } else
            showDialogue("Transaction Error", "There was an Error while sending your transaction: <b>" + e.message + "</b><br><b>StackTrace</b><br><i>" + e.stack + "</i>");
        }, 50);
